...
import static org.openhab.binding.bluelink.internal.BluelinkBindingConstants.CLIENT_ID_US;
import static org.openhab.binding.bluelink.internal.BluelinkBindingConstants.CLIENT_SECRET_US;
...
public class BluelinkApiUS extends AbstractBluelinkApi<Vehicle> {
    ...
    public void addStandardHeaders(final Request request) {
        request.header(HttpHeader.CONTENT_TYPE, APPLICATION_JSON)
                ...
                .header("from", "SPA").header("to", "ISS").header("language", "0").header("client_id", CLIENT_ID_US)
                .header("clientSecret", CLIENT_SECRET_US).header("brandIndicator", "H")
