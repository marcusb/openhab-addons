...
* Force Refresh. This requests up-to-date data from the vehicle, unlike regular periodic refresh that may
  return cached values. This action is heavily rate-limited by the API.
* Climate Start
* Climate Stop
...
| `refreshInterval` | No       | 10      | Status refresh interval in minutes  |
